...
from app.schemas.user_schemas import LoginRequest, LoginResponse, LogoutRequest, UserResponse
...
def logout(data: LogoutRequest, service: UserService = Depends(get_service)):
